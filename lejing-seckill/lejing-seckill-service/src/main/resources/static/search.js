...
api[0].list[0].list.push({
    order: '1',
    deprecated: 'false',
    url: 'http://localhost:25000/seckill/on/shelve/seckill/sku/latest/3days',
    desc: '上架最近三天的秒杀商品',
});
api[0].list[0].list.push({
    order: '2',
    deprecated: 'false',
    url: 'http://localhost:25000/seckill/current/can/seckill/skus',
    desc: '获取当前时间参与秒杀的商品',
});
api[0].list[0].list.push({
    order: '3',
    deprecated: 'false',
    url: 'http://localhost:25000/seckill/sku/info/{skuId}',
    desc: '查询商品是否参加秒杀活动',
});
api[0].list[0].list.push({
    order: '4',
