/*
 ...
 Source Schema         : lejing_oms

 Target Server Type    : MySQL
 Target Server Version : 80023
 File Encoding         : 65001

 Date: 04/02/2021 22:09:11
*/
...
(
    ...
    `to_exchange`    varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '目标交换机',
    `routing_key`    varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '路由键',
    `class_type`     varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '全限定类名',
    `message_status` int                                                           NULL DEFAULT 0 COMMENT '0-新建1-已发送2错误抵达3-已抵达',
    `create_time`    datetime                                                      NULL DEFAULT NULL COMMENT '创建时间',
    `update_time`    datetime                                                      NULL DEFAULT NULL COMMENT '更新时间',
    PRIMARY KEY (`message_id`) USING BTREE
) ENGINE = InnoDB
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT = 'MQ消息表'
  ROW_FORMAT = DYNAMIC;
...
(
  ...
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT = '订单项信息'
  ROW_FORMAT = DYNAMIC;
...
(
  ...
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT = '订单操作历史记录'
  ROW_FORMAT = DYNAMIC;
...
(
  ...
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT = '订单退货申请'
  ROW_FORMAT = DYNAMIC;
...
(
  ...
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT = '退货原因'
  ROW_FORMAT = DYNAMIC;
...
(
  ...
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT = '订单配置信息'
  ROW_FORMAT = DYNAMIC;
...
(
  ...
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT = '支付信息表'
  ROW_FORMAT = DYNAMIC;
...
(
  ...
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT = '退款信息'
  ROW_FORMAT = DYNAMIC;
