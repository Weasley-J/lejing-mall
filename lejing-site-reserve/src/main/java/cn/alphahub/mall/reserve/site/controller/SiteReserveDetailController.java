...
import cn.alphahub.mall.reserve.site.service.SiteReserveDetailService;
...
public class SiteReserveDetailController {
    @Autowired
     ...
     */
    @GetMapping("/list")
    public Result<PageResult<SiteReserveDetail>> list(
