...
import cn.alphahub.mall.generator.entity.ColumnEntity;
import cn.alphahub.mall.generator.entity.TableEntity;
import cn.alphahub.mall.generator.entity.mongo.MongoDefinition;
import cn.alphahub.mall.generator.entity.mongo.MongoGeneratorEntity;
...
public class GenUtils {
    ...
    public static void generatorCode(Map<String, String> table,
        ...
        //配置信息
        Configuration config = getCodeGeneratorConfig();
        ...
        for (Map<String, String> column : columns) {
            ...
            if (containsName || containsTitle) {
                javaFieldContainsNameOrTitle = true;
            }
            //是否主键
        ...
        mainPath = StringUtils.isBlank(mainPath) ? "cn.alphahub" : mainPath;
        //封装模板数据
     ...
     * 获代码生成配置信息
     */
    public static Configuration getCodeGeneratorConfig() {
        SysGeneratorService generatorService = SpringUtil.getBean(SysGeneratorService.class);
        Properties properties = generatorService.getGeneratorProperties();
        Configuration configuration = new PropertiesConfiguration();
        properties.forEach((k, v) -> configuration.setProperty(String.valueOf(k), v));
