...
public class BillingDetailQueryResponse implements Serializable {
     ...
     * 订单号
     */
    @Excel(name = "订单号", width = 22, needMerge = true)
    private String orderNo;
    /**
     * 交易流水号
     */
    @Excel(name = "交易流水号", width = 22, needMerge = true)
     ...
     * </ul>
     */
    @Excel(name = "收支类型", replace = {"支出_0", "收入_1", "_null"}, needMerge = true)
    private Integer incomeExpendType;
    /**
     * 状态: 0 未付款 1 已付款
     */
    @Excel(name = "状态", replace = {"未付款_0", "已付款_1", "_null"}, needMerge = true)
    private Integer settlePayStatus;
    /**
     * 交易来源：0 商城，1 疫苗
     */
    @Excel(name = "交易来源", replace = {"商城_0", "疫苗_1", "_null"}, needMerge = true)
    private Integer orderSource;
    /**
     * 商品名称
     */
    @Excel(name = "商品名称", width = 45, needMerge = true)
    private String goodsName;
    /**
     * 商品规格
     */
    @Excel(name = "商品规格", width = 30, needMerge = true)
     ...
     * 零售价
     */
    @Excel(name = "零售价", width = 15, needMerge = true)
     ...
     * 商品总金额 （ 商品零售价 * 商品数量 ）
     */
    @Excel(name = "商品总金额", width = 15, needMerge = true)
     ...
     * 平台优惠明细
     */
    @ExcelCollection(id = "platformDiscountList", name = "平台优惠明细", type = List.class)
    private List<PlatformDiscountVo> platformDiscountList;
    /**
     * 商家优惠明细
     */
    @ExcelCollection(id = "merchantDiscountList", name = "商家优惠明细", type = List.class)
    private List<MerchantDiscountVo> merchantDiscountList;
    /**
     * 抵扣金额明细
     */
    @ExcelCollection(id = "deductAmountList", name = "抵扣金额明细", type = List.class)
    private List<DeductVo> deductAmountList;
    /**
     * 实收金额 （liquidation_trade_order_item.trade_amount 商品交易金额（实际付款分摊的金额））
     */
    @Excel(name = "实收金额", width = 13, needMerge = true)
    private BigDecimal actualAmount;
    /**
     * 佣金率
     */
    @Excel(name = "佣金率", width = 13, needMerge = true)
    private BigDecimal platformCommissionRatio;
    /**
     * 佣金
     */
    @Excel(name = "佣金", width = 13, needMerge = true)
    private BigDecimal platformCommissionAmount;
    /**
     * 结算金额
     */
    @Excel(name = "结算金额", width = 13, needMerge = true)
    private BigDecimal settleAmount;
    /**
     * 结算时间
     */
    @Excel(name = "结算时间", format = "yyyy-MM-dd HH:mm:ss", width = 22, needMerge = true)
    @JsonFormat(pattern = "yyyy-MM-dd HH:mm:ss", timezone = "GMT+8")
    private LocalDateTime settleTime;
    /**
     * 结算模式 1 自营 0 代理
     */
    @Excel(name = "结算模式", replace = {"自营_1", "代理_0", "_null"}, width = 12, needMerge = true)
    private Integer settleType;
    /**
     * 供应商名称
     */
    @Excel(name = "供应商名称", width = 13, needMerge = true)
    private String supplierName;
    /**
     * 供应商id
     */
    @Excel(name = "供应商id", width = 12, needMerge = true)
    @JsonSerialize(using = ToStringSerializer.class)
    private Long supplierId;
    /**
     * 商品skuId
     */
    @Excel(name = "商品skuId", width = 12, needMerge = true)
    @JsonSerialize(using = ToStringSerializer.class)
    private Long skuId;
    /**
     * 商户订单号
     */
    @Excel(name = "商户订单号", width = 35, needMerge = true)
    private String payNo;
    /**
     * 三方订单号
     */
    @Excel(name = "三方订单号", width = 35, needMerge = true)
    private String thirdTransactionNo;
    /**
     * 支付方式：ALI_PAY(支付宝支付),WECHAT_PAY（微信支付）
     */
    @Excel(name = "支付方式", width = 12, needMerge = true)
    private String payChannelCode;
    /**
     * 支付时间
     */
    @Excel(name = "支付时间", format = "yyyy-MM-dd HH:mm:ss", width = 22, needMerge = true)
    @JsonFormat(pattern = "yyyy-MM-dd HH:mm:ss", timezone = "GMT+8")
    private LocalDateTime paySuccessTime;
    /**
     * 是否处方药
     */
    @Excel(name = "是否处方药", width = 13, replace = {"是_true", "否_false"}, needMerge = true)
