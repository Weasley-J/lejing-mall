...
public class OrderExcelDTO implements Serializable {
     ...
     */
    @Excel(name = "支付方式", orderNum = "15", replace = {"支付宝_1", "微信_2", "银联_3", "货到付款_4",})
     ...
     */
    @Excel(name = "订单状态", orderNum = "17", replace = {"待付款_0", "已付款_1", "已发货_2", "已完成_3", "已取消_4", "售后中_5", "售后完成_6"})
     ...
     */
    @Excel(name = "发票类型", orderNum = "23", replace = {"电子发票_1", "纸质发票_3",})
     ...
     * 确认收货状态[0->未确认；1->已确认]
     */
    @Excel(name = "确认收货状态", orderNum = "36", replace = {"未确认_0", "已确认_1"})
    private Integer confirmStatus;

    /**
     * 删除状态【0->未删除；1->已删除】
     */
    @Excel(name = "删除状态", orderNum = "37", replace = {"未删除_0", "已删除_1"})
